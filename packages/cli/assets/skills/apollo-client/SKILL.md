---
name: apollo-client
description: GraphQL con Apollo Client — hooks, fetchPolicy, normalización de caché y actualización tras mutaciones. Trigger: al escribir queries/mutations, configurar la caché o los links.
---
